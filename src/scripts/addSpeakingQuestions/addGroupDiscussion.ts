...
const questions = [
  {
    ...
    audioUrl: "https://example.com/audio/education-tech-discussion.mp3",
  ...
  },
  {
    ...
    audioUrl: "https://example.com/audio/remote-work-discussion.mp3",
  ...
  },
  {
    ...
    audioUrl: "https://example.com/audio/climate-solutions-discussion.mp3",
  ...
  },
  {
    ...
    audioUrl: "https://example.com/audio/social-media-discussion.mp3",
  ...
  },
  {
    ...
    audioUrl: "https://example.com/audio/ai-healthcare-discussion.mp3",
  ...
  },
  {
    ...
    audioUrl: "https://example.com/audio/urban-planning-discussion.mp3", 
...
const createGroupDiscussionQuestions = async () => {
  try {
    ...
    for (const questionData of questions) {
      ...
      // Create the question
      const question = await prisma.speakingGroupDiscussionQuestion.create({
        data: {
