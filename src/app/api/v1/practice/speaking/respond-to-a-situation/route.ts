...
export async function GET(request: NextRequest) {
    try {
        ...
        const result = await speakingController.getRespondToASituationQuestions(userId, queryParams);
        return NextResponse.json(
            {
                success: true,
        ...
        console.error("Error fetching respond to a situation questions:", error);
        return NextResponse.json(
            {
                success: false,
