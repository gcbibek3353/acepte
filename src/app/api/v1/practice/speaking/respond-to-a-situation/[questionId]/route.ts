...
export async function GET(
    ...
    try {
        ...
        const question = await speakingController.getRespondToASituationQuestionById(questionId);
...
export async function POST(req: NextRequest,
    ...
    try {
        ...
        const evaluation = await speakingController.postRespondToASituationAnswer(userId, questionId, audioUrl);
        return NextResponse.json(
            {
                success: true,
