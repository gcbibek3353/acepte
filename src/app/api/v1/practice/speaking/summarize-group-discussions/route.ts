...
export async function GET(request: NextRequest) {
    try {
        ...
        const result = await speakingController.getSummarizeGroupDiscussionQuestions(userId, queryParams);
        return NextResponse.json(
            {
                success: true,
        ...
        console.error("Error fetching summarize group discussions questions:", error);
        return NextResponse.json(
            {
                success: false,
