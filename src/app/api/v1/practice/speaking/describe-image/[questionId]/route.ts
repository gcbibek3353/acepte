...
export async function GET(
    ...
    try {
        ...
        const question = await speakingController.getDescribeImageQuestionById(questionId);
...
export async function POST(req: NextRequest,
    ...
    try {
        ...
        const evaluation = await speakingController.postDescribeImageAnswer(userId, questionId, audioUrl);
        return NextResponse.json(
            {
                success: true,
