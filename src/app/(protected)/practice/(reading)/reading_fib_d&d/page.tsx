...
import { FibDragDropListItem } from '@/types/reading'
import React from 'react'

const ReadingFIBDragAndDrop = () => {
  const { data, loading, error, queryParams, setQueryParams } = useFilteredAPI<FibDragDropListItem[]>('/api/v1/practice/reading/fibDragDrop');
