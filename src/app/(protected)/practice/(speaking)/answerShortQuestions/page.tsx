...
const AnswerShortQuestion = () => {
  const { data, loading, error, queryParams, setQueryParams } = useFilteredAPI<QuestionsParams[]>('/api/v1/practice/speaking/answer-short-question');
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-gray-800 mb-8">Answer Short Questions</h1>
