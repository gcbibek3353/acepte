...
const SummarizeGroupDiscussions = () => {
  const { data, loading, error, queryParams, setQueryParams } = useFilteredAPI<QuestionsParams[]>('/api/v1/practice/speaking/summarize-group-discussions');
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-5xl px-4 py-8 sm:px-6">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Summarize Group Discussion</h1>
