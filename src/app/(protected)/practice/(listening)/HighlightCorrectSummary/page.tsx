...
import { ListeningHcsListItem } from '@/types/listening'
import React from 'react'

const HighlightCorrectSummaryPage = () => {
  const { data, loading, error, queryParams, setQueryParams } = useFilteredAPI<ListeningHcsListItem[]>('/api/v1/practice/listening/highlightCorrectSummary');
