...
import { ListeningSmwListItem } from '@/types/listening'
import React from 'react'

const SelectMissingWordPage = () => {
  const { data, loading, error, queryParams, setQueryParams } = useFilteredAPI<ListeningSmwListItem[]>('/api/v1/practice/listening/selectMissingWord');
