...
import { ListeningFibListItem } from '@/types/listening'
import React from 'react'

const FillInTheBlanks = () => {
  const { data, loading, error, queryParams, setQueryParams } = useFilteredAPI<ListeningFibListItem[]>('/api/v1/practice/listening/fillTheBlanks');
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-4xl px-4 py-8 sm:px-6">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Fill in the Blanks</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Listen to the audio and type the missing words in the blanks.
          </p>
        </div>
