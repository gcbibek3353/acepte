...
interface Props {
  answers: ListeningMcsDetail['answers']
  options: ListeningMcsDetail['options']
  correctOptionIndex: ListeningMcsDetail['correctOptionIndex']
}

const Listening_mcs_answer = ({ answers, options, correctOptionIndex }: Props) => {
  if (answers.length === 0) {
    return (
...
export default Listening_mcs_answer
